        ...
        <div className="container">
          <div className="marketingOne">
            ...
            <div className="market-img">
              ...
              <div className="market-title">
                ...
                <h6>
                  {" "}
                  <span></span>Прогрессивный налог на будущее. Суть метода в
          ...
          >
            ...
            <p>
              ...
              сбережений в государственных бумагах, фиксированных к инфляции.Эти
          ...
          <div className="read-more">
            {showMore ? (
              <>
                ...
                <p>
                  Хранить эти деньги стоит диверсифицированно. 10% сбережений
                  оставляйте в национальной валюте вашей страны. 90 %
                  распределите на 3 валюты: швейцарский франк, норвежская крона,
                  и что-то из: американского доллара, евро либо йены.
                  Рассмотрите варианты сбережений в государственных бумагах,
                  фиксированных к инфляции.Эти рекомендации касаются личного
                  бюджета. Ниже мы рассмотрим основные финансовые рискив бизнесе
                  и стратегии управления ими.
                </p>
              </>
            ) : null}
            <button onClick={toggleShowMore}>
              {showMore ? "Скрыть" : "Читать больше"}
            </button>
          </div>

          <button onClick={openModal} className="market-btn">
            купить курс
          </button>
          {isOpen && (
            <div className="modal">
                  ...
                  <div className="modal--content__panel--general">
                    ...
                    <div className="modal--content__panel--general__inputs">
                      ...
                      <div className="modal--content__panel--general__inputs--right">
                        ...
                        <div className="op">
                          <button className="op-btn" onClick={closeModal}>
                            Назад{" "}
                          </button>
                          <button
                            onClick={() => {
                              handlePayment(setModal(!modal));
                            }}
                          >
                            Оплата
                          </button>
